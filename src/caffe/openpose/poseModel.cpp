...
// // More information: Page 6 of http://www.mccc.edu/~behrensb/documents/TheHandbig.pdf
    ...
    const std::array<std::vector<float>, (int)PoseModel::Size> DISTANCE_AVERAGE{
        ...
        // std::vector<float>{3.99662, 2.83036, 6.70038, 7.98778, 2.83036, 6.6937, 7.98559, 9.03892, // 25 (COCO_25, COCO_25_17)
        //                    9.25788, 13.5094, 18.4561, 9.25499, 13.5129, 18.452,
        //                    4.45502, 4.45194, 4.06345, 4.0489,
        //                    18.452, 18.452, 18.452, 18.4561, 18.4561, 18.4561},
        //                    // 15.6355, 15.6056, 15.0701, 15.6164, 15.6026, 15.0402},
        std::vector<float>{12.2641, 8.8916, 9.2850, 6.5674, 6.5413, 9.2862, 6.5579, 6.5103,
                           1.7445, 6.4879, 11.0845, 1.7445, 6.4977, 11.0991,
                           12.7577, 12.7654, 12.3408, 12.3096,
                           10.5306, 10.4568, 9.6233, 10.4409, 10.3460, 9.6385},
        ...
        // std::vector<float>{3.99662, 2.83036, 6.70038, 7.98778, 2.83036, 6.6937, 7.98559, 9.03892, // 25 (COCO_25E, COCO_25_17E)
        //                    9.25788, 13.5094, 18.4561, 9.25499, 13.5129, 18.452,
        //                    4.45502, 4.45194, 4.06345, 4.0489,
        //                    18.452, 18.452, 18.452, 18.4561, 18.4561, 18.4561},
        //                    // 15.6355, 15.6056, 15.0701, 15.6164, 15.6026, 15.0402},
    ...
    const std::array<unsigned int, (int)PoseModel::Size> ROOT_INDEXES{
        ...
        1u,     // COCO_19b
        1u,     // COCO_19_V2
        8u,     // 25 (COCO_25, COCO_25_17)
        1u,     // 65 (MPII_65_42)
        1u,     // CAR_12
        8u,     // 25 (COCO_25E, COCO_25_17E)
    };
